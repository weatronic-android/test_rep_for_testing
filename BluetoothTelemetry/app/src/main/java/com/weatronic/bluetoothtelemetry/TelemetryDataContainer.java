    ...
    public TelemetryDataContainer(Context ctx, int protocolID){
        ...
        switch(protocolID) {
            case TelemetryData.PROTOCOL_DV4:
                ...
                TelemetryDataSimple LinkVario_temperature = new TelemetryDataNumber(0x4402, LV + ctx.getString(R.string.Temperature), -40, 125, "°C", 0.1f);
                ...
                TelemetryDataArrayVirtual MUX_A1_temperature = new TelemetryDataArrayVirtual(0x5502, 0x0010, MUX + " A1 " + ctx.getString(R.string.Temperature) + packet, MUX + " A1 " + ctx.getString(R.string.Temperature) + board, 16, -40, 125, "°C", 0.1f);
                TelemetryDataArrayVirtual MUX_A2_temperature = new TelemetryDataArrayVirtual(0x5D02, 0x0010, MUX + " A2 " + ctx.getString(R.string.Temperature) + packet, MUX + " A2 " + ctx.getString(R.string.Temperature) + board, 16, -40, 125, "°C", 0.1f);
                TelemetryDataArrayVirtual MUX_A3_temperature = new TelemetryDataArrayVirtual(0x6502, 0x0010, MUX + " A3 " + ctx.getString(R.string.Temperature) + packet, MUX + " A3 " + ctx.getString(R.string.Temperature) + board, 16, -40, 125, "°C", 0.1f);
                TelemetryDataArrayVirtual MUX_A4_temperature = new TelemetryDataArrayVirtual(0x6D02, 0x0010, MUX + " A4 " + ctx.getString(R.string.Temperature) + packet, MUX + " A4 " + ctx.getString(R.string.Temperature) + board, 16, -40, 125, "°C", 0.1f);
                TelemetryDataArrayVirtual MUX_PT1000_temperature = new TelemetryDataArrayVirtual(0x7E02, 0x0010, MUX + " PT1000 " + ctx.getString(R.string.Temperature) + packet, MUX + " PT1000 " + ctx.getString(R.string.Temperature) + board, 16, -40, 125, "°C", 0.1f);
                ...
                TelemetryDataSimple Tx_temperature = new TelemetryDataNumber(0xEE00, Tx + ctx.getString(R.string.Temperature), -40, 125, "°C", 0.1f);
                TelemetryDataSimple Rx_temperature = new TelemetryDataNumber(0xEF00, Rx + ctx.getString(R.string.Temperature), -40, 125, "°C", 0.1f);
                ...
                TelemetryDataSimple RSSI_Tx_1 = new TelemetryDataNumber(0xFA01, Tx + ctx.getString(R.string.RSSI_1), -128, 20, "dBm", 0.5f, -72);
                TelemetryDataSimple RSSI_Tx_2 = new TelemetryDataNumber(0xFA11, Tx + ctx.getString(R.string.RSSI_2), -128, 20, "dBm", 0.5f, -72);
                TelemetryDataSimple RSSI_Rx_1 = new TelemetryDataNumber(0xFB01, Rx + ctx.getString(R.string.RSSI_1), -128, 20, "dBm", 0.5f, -72);
                TelemetryDataSimple RSSI_Rx_2 = new TelemetryDataNumber(0xFB11, Rx +ctx.getString(R.string.RSSI_2), -128, 20, "dBm", 0.5f, -72);
            ...
            case TelemetryData.PROTOCOL_SKYNAVIGATOR:
                ...
                TelemetryDataSimple RSSI_RxMain_1 = new TelemetryDataNumber(0x0403, RxMain + ctx.getString(R.string.RSSI_1), -40, 125, "%", 0.5f);
                TelemetryDataSimple RSSI_RxMain_2 = new TelemetryDataNumber(0x0404, RxMain + ctx.getString(R.string.RSSI_2), -40, 125, "%", 0.5f);
                TelemetryDataSimple RSSI_RxSub1_1 = new TelemetryDataNumber(0x0413, RxSub1 + ctx.getString(R.string.RSSI_1), -40, 125, "%", 0.5f);
                TelemetryDataSimple RSSI_RxSub1_2 = new TelemetryDataNumber(0x0414, RxSub1 + ctx.getString(R.string.RSSI_2), -40, 125, "%", 0.5f);
                TelemetryDataSimple RSSI_RxSub2_1 = new TelemetryDataNumber(0x0423, RxSub2 + ctx.getString(R.string.RSSI_1), -40, 125, "%", 0.5f);
                TelemetryDataSimple RSSI_RxSub2_2 = new TelemetryDataNumber(0x0424, RxSub2 + ctx.getString(R.string.RSSI_2), -40, 125, "%", 0.5f);
                TelemetryDataSimple batRSSI_Tx_1 = new TelemetryDataNumber(0x0483, Tx + ctx.getString(R.string.RSSI_1), -40, 125, "%", 0.5f);
                TelemetryDataSimple batRSSI_Tx_2 = new TelemetryDataNumber(0x0484, Tx + ctx.getString(R.string.RSSI_2), -40, 125, "%", 0.5f);
                TelemetryDataSimple Temperature_RxMain = new TelemetryDataNumber(0x0408, RxMain + ctx.getString(R.string.Temperature), -40, 125, "°C");
                TelemetryDataSimple Temperature_RxSub1 = new TelemetryDataNumber(0x0418, RxSub1 + ctx.getString(R.string.Temperature), -40, 125, "°C");
                TelemetryDataSimple Temperature_RxSub2 = new TelemetryDataNumber(0x0428, RxSub2 + ctx.getString(R.string.Temperature), -40, 125, "°C");
                TelemetryDataSimple Temperature_Tx = new TelemetryDataNumber(0x0485, Tx + ctx.getString(R.string.Temperature), -40, 125, "°C");
                ...
                TelemetryDataSimple sensor1_temperature1 = new TelemetryDataNumber(0x1388, sensor + "1 " + ctx.getString(R.string.Temperature) + " 1", -40, 125, "°C", 1.0f);
                TelemetryDataSimple sensor1_temperature2 = new TelemetryDataNumber(0x1389, sensor + "1 " + ctx.getString(R.string.Temperature) + " 2", -40, 125, "°C", 1.0f);
                ...
                TelemetryDataSimple sensor2_temperature1 = new TelemetryDataNumber(0x13A8, sensor + "2 " + ctx.getString(R.string.Temperature) + " 1", -40, 125, "°C", 1.0f);
                TelemetryDataSimple sensor2_temperature2 = new TelemetryDataNumber(0x13A9, sensor + "2 " + ctx.getString(R.string.Temperature) + " 2", -40, 125, "°C", 1.0f);
                ...
                TelemetryDataSimple sensor3_temperature1 = new TelemetryDataNumber(0x13C8, sensor + "3 " + ctx.getString(R.string.Temperature) + " 1", -40, 125, "°C", 1.0f);
                TelemetryDataSimple sensor3_temperature2 = new TelemetryDataNumber(0x13C9, sensor + "3 " + ctx.getString(R.string.Temperature) + " 2", -40, 125, "°C", 1.0f);
                ...
                TelemetryDataSimple sensor4_temperature1 = new TelemetryDataNumber(0x13E8, sensor + "4 " + ctx.getString(R.string.Temperature) + " 1", -40, 125, "°C", 1.0f);
                TelemetryDataSimple sensor4_temperature2 = new TelemetryDataNumber(0x13E9, sensor + "4 " + ctx.getString(R.string.Temperature) + " 2", -40, 125, "°C", 1.0f);
                ...
                TelemetryDataSimple batLinkVario_temperature = new TelemetryDataNumber(0x1585, LV + ctx.getString(R.string.Temperature), -40, 125, "°C", 0.1f);
                TelemetryDataSimple LinkVario_vario = new TelemetryDataNumber(0x1586, LV + ctx.getString(R.string.Vario), -50, 50, "m/s", 0.005f);

                TelemetryDataSimple MUX1_temperature_p1000 = new TelemetryDataNumber(0x1606, MUX + "1 " + ctx.getString(R.string.Temperature) + " PT1000", -200, 850, "°C", 0.1f);
                TelemetryDataSimple MUX1_temperature_A1 = new TelemetryDataNumber(0x1611,MUX + "1 " + ctx.getString(R.string.Temperature) + " A1", -200, 850, "°C", 0.1f);
                TelemetryDataSimple MUX1_temperature_A2 = new TelemetryDataNumber(0x1619, MUX + "1 " + ctx.getString(R.string.Temperature) + " A2", -200, 850, "°C", 0.1f);
                TelemetryDataSimple MUX1_temperature_A3 = new TelemetryDataNumber(0x1621, MUX + "1 " + ctx.getString(R.string.Temperature) + " A3", -200, 850, "°C", 0.1f);
                TelemetryDataSimple MUX1_temperature_A4 = new TelemetryDataNumber(0x1629, MUX + "1 " + ctx.getString(R.string.Temperature) + " A4", -200, 850, "°C", 0.1f);
                TelemetryDataSimple MUX1_temperature_A5 = new TelemetryDataNumber(0x1631, MUX + "1 " + ctx.getString(R.string.Temperature) + " A5", -200, 850, "°C", 0.1f);
                TelemetryDataSimple MUX2_temperature_p1000 = new TelemetryDataNumber(0x1646, MUX + "2 " + ctx.getString(R.string.Temperature) + " PT1000", -200, 850, "°C", 0.1f);
                TelemetryDataSimple MUX2_temperature_A1 = new TelemetryDataNumber(0x1651,MUX + "2 " + ctx.getString(R.string.Temperature) + " A1", -200, 850, "°C", 0.1f);
                TelemetryDataSimple MUX2_temperature_A2 = new TelemetryDataNumber(0x1659, MUX + "2 " + ctx.getString(R.string.Temperature) + " A2", -200, 850, "°C", 0.1f);
                TelemetryDataSimple MUX2_temperature_A3 = new TelemetryDataNumber(0x1661, MUX + "2 " + ctx.getString(R.string.Temperature) + " A3", -200, 850, "°C", 0.1f);
                TelemetryDataSimple MUX2_temperature_A4 = new TelemetryDataNumber(0x1669, MUX + "2 " + ctx.getString(R.string.Temperature) + " A4", -200, 850, "°C", 0.1f);
                TelemetryDataSimple MUX2_temperature_A5 = new TelemetryDataNumber(0x1671, MUX + "2 " + ctx.getString(R.string.Temperature) + " A5", -200, 850, "°C", 0.1f);
                TelemetryDataSimple MUX3_temperature_p1000 = new TelemetryDataNumber(0x1686, MUX + "3 " + ctx.getString(R.string.Temperature) + " PT1000", -200, 850, "°C", 0.1f);
                TelemetryDataSimple MUX3_temperature_A1 = new TelemetryDataNumber(0x1691,MUX + "3 " + ctx.getString(R.string.Temperature) + " A1", -200, 850, "°C", 0.1f);
                TelemetryDataSimple MUX3_temperature_A2 = new TelemetryDataNumber(0x1699, MUX + "3 " + ctx.getString(R.string.Temperature) + " A2", -200, 850, "°C", 0.1f);
                TelemetryDataSimple MUX3_temperature_A3 = new TelemetryDataNumber(0x16A1, MUX + "3 " + ctx.getString(R.string.Temperature) + " A3", -200, 850, "°C", 0.1f);
                TelemetryDataSimple MUX3_temperature_A4 = new TelemetryDataNumber(0x16A9, MUX + "3 " + ctx.getString(R.string.Temperature) + " A4", -200, 850, "°C", 0.1f);
                TelemetryDataSimple MUX3_temperature_A5 = new TelemetryDataNumber(0x16B1, MUX + "3 " + ctx.getString(R.string.Temperature) + " A5", -200, 850, "°C", 0.1f);
                TelemetryDataSimple MUX4_temperature_p1000 = new TelemetryDataNumber(0x16C6, MUX + "4 " + ctx.getString(R.string.Temperature) + " PT1000", -200, 850, "°C", 0.1f);
                TelemetryDataSimple MUX4_temperature_A1 = new TelemetryDataNumber(0x16D1,MUX + "4 " + ctx.getString(R.string.Temperature) + " A1", -200, 850, "°C", 0.1f);
                TelemetryDataSimple MUX4_temperature_A2 = new TelemetryDataNumber(0x16D9, MUX + "4 " + ctx.getString(R.string.Temperature) + " A2", -200, 850, "°C", 0.1f);
                TelemetryDataSimple MUX4_temperature_A3 = new TelemetryDataNumber(0x16E1, MUX + "4 " + ctx.getString(R.string.Temperature) + " A3", -200, 850, "°C", 0.1f);
                TelemetryDataSimple MUX4_temperature_A4 = new TelemetryDataNumber(0x16E9, MUX + "4 " + ctx.getString(R.string.Temperature) + " A4", -200, 850, "°C", 0.1f);
                TelemetryDataSimple MUX4_temperature_A5 = new TelemetryDataNumber(0x16F1, MUX + "4 " + ctx.getString(R.string.Temperature) + " A5", -200, 850, "°C", 0.1f);
